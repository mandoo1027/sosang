...
const callApi = () => {
  ...
  commonApi
    ...
    .then((response) => {
      ...
      if (searchParams.value.sysDivCd === 'ADM') {
        resultData = response.RES_DAT.adm
        isEdit.value = true
        isAdmin.value = true
        $agGridUtils.changeHeaderName(
          agGrid.value.gridOption.api,
        ...
        isEdit.value = true
        resultData = response.RES_DAT.efm
        const efmoList = response.RES_DAT.efmo ?? []
        const efmcList = response.RES_DAT.efmc ?? []
        const efmpList = response.RES_DAT.efmp ?? []
        ...
        resultData = response.RES_DAT.efmo
        isEdit.value = false
      } else if (searchParams.value.sysDivCd === 'EFMC') {
        resultData = response.RES_DAT.efmc
        isEdit.value = false
      } else if (searchParams.value.sysDivCd === 'EZP') {
        resultData = response.RES_DAT.efmp
        isEdit.value = false
      }
