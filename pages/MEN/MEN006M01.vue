...
const callApi = () => {
  ...
  menuApi
    .MEN0601S01(params)
    .then((response) => {
      const resultData = response.RES_DAT.batSvcList
      const resultData1 = response.RES_DAT.infrmList
      const resultData2 = response.RES_DAT.vraNoList
      const resultData3 = response.RES_DAT.actrsfList
...
const callSmsApi = (sms) => {
  ...
  menuApi
    .MEN0601I01(params)
    .then((response) => {
      const result = response.RES_DAT.result
      if (result) {
